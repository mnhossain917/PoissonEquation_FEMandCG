...
#include "ConjugateGradient_LinSys.cc"
...
{   
    ...
    double *SolVecGlobal0;
    SolVecGlobal0=new double[nNodeBC];
    for (int i=0; i<nNodeBC; i++)
       SolVecGlobal0[i]=0; // Initial Solution 

    CG_LinSys(Kmat_Global_BcImpd, Fvec_Global_BcImpd, SolVecGlobal0, nNodeInBC);
    ...
    {  i_bc =NodeInBoundry[i]-1;
        SolVecGlobal[i_bc]=SolVecGlobal0[i]; }
